...
6. **Write design doc** — save to `.plan/YYYY-MM-DD-<topic>-design.md` and commit
...
- `.plan/archive/` — completed specs. Once the work described by a spec has shipped, move the file from `.plan/` into `.plan/archive/` (keeping the filename intact) so `.plan/` only reflects open work.
